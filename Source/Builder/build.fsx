...
let ProjectName = "Havoc";
let GitHubUrl = "https://github.com/bchavez/Havoc"

let Folders = Setup.Folders(workingDir, workingDir)
let Files = Setup.Files(ProjectName, Folders)

let TestProject = TestProject("Havoc.Tests", Folders)

let TestProjects = [ TestProject; ]

let NugetProjects = [
                       NugetProject("Havoc", "Havoc chaos-engineering for .NET", Folders)
                    ]
...
"BuildInfo" =?> ("setup-snk", true) ==> "dnx" ==> "zip"
